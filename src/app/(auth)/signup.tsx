...
const SignUpScreen = () => {
  ...
  const handleSignUp = async () => {
    ...
    if(password.length < 3) {
      Alert.alert("Password must be 3 characters or more");
      return;
    }
       ...
       <View style={styles.content}>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity style={styles.linkButton}>
            <Text style={styles.linkButtonText}>Already have an account? <Text style={styles.linkButtonTextBold} onPress={() => router.push("/(auth)/login")}>Login</Text></Text>
          </TouchableOpacity>
        </View>
      </View>
